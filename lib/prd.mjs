...
function parseRequirements(text) {
  ...
  result.push(
    ...lines(text).filter((line) =>
      /must|should|required|requirement|visual|font|layout|responsive|mobile|desktop|asset|image|hero|mascot|raster|3d|glass|cinematic|premium|texture|background|illustration|rendered|banner|overlap|clip/i.test(line)
    )
  );
