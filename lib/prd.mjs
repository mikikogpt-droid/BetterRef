...
function makeRunbook({ configPath, summaryPath, guardConfigPath, prdChecklistPath, referencePath, url, assetQualityRequired }) {
...
`;
  ...
  await writeFile(runbookPath, makeRunbook({ configPath, summaryPath, guardConfigPath, prdChecklistPath, referencePath, url, assetQualityRequired }));
